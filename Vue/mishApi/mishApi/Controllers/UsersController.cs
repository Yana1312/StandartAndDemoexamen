...
namespace mishApi.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        public UsersController(StorePinkBearDbContext context)
        {
            _context = context;
        }
        ...
        {
            using (var context = new StorePinkBearDbContext())
            {
                ...
                if (client == null)
                {
                    ...
                    if (client1 == null)  return BadRequest("Пользователь с таким логином не найден");
                    else return BadRequest("Неверный пароль");
                }
                return Ok(client);
            }
        }
